            ...
            <x-panel>
                <form method="POST" action="/post/{{ $post->slug}}/comments">
                    ...
                    <header class="flex items-center">
                        ...
                        <div class="mt-6">
                            <textarea name="body" class="w-full text-sm focus::outline-none focus:ring" cols="30" rows="5" placeholder="Comment!"></textarea>
                        </div>

                        <div class="flex justify-end mt-8 pt-6 border-t border-gray-200">
                            <button type="submit" class="bg-blue-500 text-white font-semibold text-xs py-2 px-10 hover:bg-blue-700 rounded-xl">Post</button>
                        </div>
                </form>
            </x-panel>
        </section>
